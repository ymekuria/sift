      ...
      <div className="section custom ">
        <Paper style={customContainer}>
          <div className="customChoose">
            <div>
              <TextField
                hintText="Name your table"
                floatingLabelText="Tablename"
            ...
            <div>
              <TextField
                hintText="Name your column"
                floatingLabelText="Column name"
                onChange={this.updateColumn.bind(this)}
          ...
          <div className="customSelections clearfix">
            ...
            <div style={{ marginTop: 14 }}>
              <button type="button" onClick={this.postTable.bind(this)}>
                Create table
              </button>
            </div>
          </div>
